...
// ===========================
// BookService Protobuf Client
// ===========================

type bookServiceProtobufClient struct {
	client HTTPClient
	urls   [2]string
	opts   twirp.ClientOptions
}

// NewBookServiceProtobufClient creates a Protobuf client that implements the BookService interface.
...
func NewBookServiceProtobufClient(addr string, client HTTPClient, opts ...twirp.ClientOption) BookService {
	...
	prefix := urlBase(addr) + BookServicePathPrefix
	urls := [2]string{
		prefix + "Create",
		prefix + "Find",
	}

	return &bookServiceProtobufClient{
		client: client,
		urls:   urls,
		opts:   clientOpts,
	}
...
func (c *bookServiceProtobufClient) Create(ctx context.Context, in *BookServiceReq_Create) (*Book, error) {
	ctx = ctxsetters.WithPackageName(ctx, "yiplee.twirp.gateway.service")
	ctx = ctxsetters.WithServiceName(ctx, "BookService")
...
func (c *bookServiceProtobufClient) Find(ctx context.Context, in *BookServiceReq_Find) (*Book, error) {
	ctx = ctxsetters.WithPackageName(ctx, "yiplee.twirp.gateway.service")
	ctx = ctxsetters.WithServiceName(ctx, "BookService")
...
// =======================
// BookService JSON Client
// =======================

type bookServiceJSONClient struct {
	client HTTPClient
	urls   [2]string
	opts   twirp.ClientOptions
}

// NewBookServiceJSONClient creates a JSON client that implements the BookService interface.
...
func (c *bookServiceJSONClient) Create(ctx context.Context, in *BookServiceReq_Create) (*Book, error) {
	ctx = ctxsetters.WithPackageName(ctx, "yiplee.twirp.gateway.service")
	ctx = ctxsetters.WithServiceName(ctx, "BookService")
	ctx = ctxsetters.WithMethodName(ctx, "Create")
	out := new(Book)
...
func (c *bookServiceJSONClient) Find(ctx context.Context, in *BookServiceReq_Find) (*Book, error) {
	ctx = ctxsetters.WithPackageName(ctx, "yiplee.twirp.gateway.service")
	ctx = ctxsetters.WithServiceName(ctx, "BookService")
	ctx = ctxsetters.WithMethodName(ctx, "Find")
	out := new(Book)
...
func (s *bookServiceServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// BookServicePathPrefix is used for all URL paths on a twirp BookService server.
// Requests are always: POST BookServicePathPrefix/method
// It can be used in an HTTP mux to route twirp requests along with non-twirp requests on other routes.
const BookServicePathPrefix = "/twirp/yiplee.twirp.gateway.service.BookService/"

func (s *bookServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "yiplee.twirp.gateway.service")
	ctx = ctxsetters.WithServiceName(ctx, "BookService")
	...
	switch req.URL.Path {
	case "/twirp/yiplee.twirp.gateway.service.BookService/Create":
		s.serveCreate(ctx, resp, req)
		return
	case "/twirp/yiplee.twirp.gateway.service.BookService/Find":
...
func (s *bookServiceServer) serveCreate(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *bookServiceServer) serveCreateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Create")
	...
	reqContent := new(BookServiceReq_Create)
	...
	func() {
		...
		respContent, err = s.BookService.Create(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Book and nil error while calling Create. nil responses are not supported"))
		return
	}
...
func (s *bookServiceServer) serveCreateProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Create")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *bookServiceServer) serveFind(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *bookServiceServer) serveFindJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Find")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	reqContent := new(BookServiceReq_Find)
	unmarshaler := jsonpb.Unmarshaler{AllowUnknownFields: true}
	if err = unmarshaler.Unmarshal(req.Body, reqContent); err != nil {
		s.writeError(ctx, resp, malformedRequestError("the json request could not be decoded"))
		return
	...
	func() {
		defer ensurePanicResponses(ctx, resp, s.hooks)
		respContent, err = s.BookService.Find(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Book and nil error while calling Find. nil responses are not supported"))
		return
	}
...
func (s *bookServiceServer) serveFindProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Find")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *bookServiceServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *bookServiceServer) ProtocGenTwirpVersion() string {
	return "v5.10.1"
}

func (s *bookServiceServer) PathPrefix() string {
	return BookServicePathPrefix
}
